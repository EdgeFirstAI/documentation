...
If you have a [Raivin Platform](../platforms/index.md) then you can deploy and run the trained Fusion model using the bundled EdgeFirst Middleware by following the tutorial [Deploying to Raivin](../models/deployment/raivin.md).
