...
The 3D bounding boxes (3) can also be displayed on the 3D canvas.  The 3D bounding box is the annotation used for [training 3D perception (Fusion) models](training.md).  More information towards the format used for the 3D bounding box is provided [here](../datasets/format.md#box3d). 
