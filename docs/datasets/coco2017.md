...
The specific Creative Commons sublicense types are described [here][sublic].
...
2. Go to the [COCO Explore Dataset][explore] page and enter the name in the search field. All you need is the non-zero number of the file name without extention.
    <figure markdown="span">
