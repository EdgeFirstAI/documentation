...
This page will show you how to copy a dataset from "Sample Project" in [EdgeFirst Studio](https://edgefirst.studio/).  You will be using this dataset to train your model.  In the following examples, you will be copying the "Raivin Ultra-Short 2025.03" dataset.
