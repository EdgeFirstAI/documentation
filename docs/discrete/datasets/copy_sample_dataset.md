...
This page will show you how to copy a dataset from "Sample Project" in {{ studio_link("EdgeFirst Studio") }}.  You will be using this dataset to train your model.  In the following examples, you will be copying the "Coffee Cup" dataset for faster training ~15 minutes.
