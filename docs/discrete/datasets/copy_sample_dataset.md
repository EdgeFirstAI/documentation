...
This page will show you how to copy a dataset from "Sample Project" in [EdgeFirst Studio](https://edgefirst.studio/).  You will be using this dataset to train your model.  In the following examples, you will be copying the "Coffee Cup" dataset for faster training ~15 minutes.

!!! note "Have you created a project?"
    It is important that you have followed through the [Getting Started](../../index.md) which shows you how to [sign up](https://edgefirst.studio/signup), [login](https://edgefirst.studio/login), and [create a project](../../getting_started/create_project.md) in EdgeFirst Studio which is crucial before starting any experiments.
