...
{{ figure("/datasets/assets/management/3d-dataset-options-history.jpg", "Tag Dataset Options") }}

Add a new tagged version of the dataset by clicking the + green button on the right of the page as shown.

{{ figure("/datasets/assets/management/3d-dataset-history-add-new-tag.jpg", "Tag Dataset Button") }}

Specify the tag version and tag description. Click "Create Tag" to tag the dataset.

{{ figure("/datasets/assets/management/3d-dataset-tag-options.jpg", "Tag Dataset Options") }}
