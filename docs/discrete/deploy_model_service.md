...
In case the manual deployment is needed, you need to connect to the device via [SSH](/docs/platforms/ssh.md):
...
Now the model is running, open the Raivin's WebUI, go to the [Segmentation Page](/docs/platforms/walkthrough.md#the-segmentation-page), and check the camera to see the model detection the object.  
