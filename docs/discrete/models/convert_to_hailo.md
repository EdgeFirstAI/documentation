...
2. Navigate to the **Artifacts** tab and click the **Hailo Converter** button under **Converters** on the right.

    {{ figure("/models/assets/conversion/hailo-converter-button.jpg", "Hailo Converter") }}

3. Pick the target hardware and quantization preset, then click **Start App** to begin the conversion.
