...
In this section, you will find instructions for converting quantized TFLite models to NXP eIQ Neutron format for NPU-accelerated inference on i.MX 95, i.MX 943, and other NXP silicon.
...
2. Navigate to the "Artifacts" tab and click on the "NXP eIQ Neutron Converter" button under "Converters" on the right
...
If you are not using EdgeFirst Studio, you can use [NXP's eIQ Neutron Converter Tool in the eIQ Toolkit](https://community.nxp.com/t5/MCX-Microcontrollers-Knowledge/eIQ-Neutron-NPU-Lab-Guides/ta-p/1799233) to allow deployment of the model in the [NXP i.MX 95](https://www.nxp.com/products/i.MX95) platform for example.  This will allow you to take [YOLOv8](https://yolov8.com/) TFLite quantized models and run them on the i.MX 95 EVK platform.
...
{{ figure("/models/assets/conversion/eIQ-toolkit-installer.jpg", "eIQ Toolkit Installer") }}
...
{{ figure("/models/assets/conversion/eIQ-toolkit-installer-executable.jpg", "eIQ Toolkit Installer") }}

Follow the Setup Wizard that pops up and accepts the terms and agreement.  

| Setup Wizard                                             | Terms and Agreement                                          |
|----------------------------------------------------------|--------------------------------------------------------------|
| ![Start](/models/assets/conversion/eIQ-setup-wizard.jpg) | ![terms](/models/assets/conversion/eIQ-terms-agreements.jpg) |
...
|--------------------------------------------------------------|-------------------------------------------------------|
| ![path](/models/assets/conversion/eIQ-installation-path.jpg) | ![install](/models/assets/conversion/eIQ-install.jpg) |
...
{{ figure("/models/assets/conversion/eIQ-portal.jpg", "eIQ Portal") }}
...
Now that the right version of Neutron Converter is available in your system, you can start converting quantized TFLite models with the command below.  You can find instructions for quantizing ONNX to TFLite in the [TFLite Quantization Guide](../../models/conversion/tflite.md#manual-ultralytics-quantization-upstream).  Otherwise, you can use this YOLOv8 Segmentation TFLite model [`yolov8s-seg_full_integer_quant.tflite`](../../models/ultralytics/assets/yolov8s-seg_full_integer_quant.tflite){: download="yolov8s-seg_full_integer_quant.tflite"} which has been pre-generated using the instructions above.
...
A new model file will be generated with the suffix "_converted.tflite".  This converted model will be ready for deployment to the i.MX 95 platform.

### Deploy Converted Model

You can deploy this converted model by following the instructions for [deploying the model on target](../../models/ultralytics/npu.md#deploying-quantized-tflite).
