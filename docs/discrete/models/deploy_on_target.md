...
{{ figure("/models/assets/deployment/evk-live.png", "EdgeFirst Live Mode on EVK") }}
...
{{ figure("/models/assets/deployment/evk-recorder-controls.png", "MCAP Recorder Controls") }}
