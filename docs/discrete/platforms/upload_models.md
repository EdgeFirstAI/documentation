...
In the [SCP section in the SSH Tutorial](../../platforms/networking/ssh.md#secure-copy), files can be uploaded to the Raivin using the command:
...
!!! note
    ...
    The above command assumes you have an SSH client, such as OpenSSH, installed.  Please review the [SSH documentation](../../platforms/networking/ssh.md) to confirm.
