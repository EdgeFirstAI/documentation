...
This functionality is available at the time of restoring a snapshot. To invoke this import/create a snapshot and then enable AGTG while restoring the snapshot. Please refer to [Restoring a snapshot](../../datasets/snapshots/ss.md) 
