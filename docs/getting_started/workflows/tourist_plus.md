...
In this workflow, you will {{ studio_link("sign up", "signup") }} for EdgeFirst Studio, {{ studio_link("log in", "login") }}, and browse the public datasets and models available in the platform.
