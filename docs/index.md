...
This workflow will show the steps for recording a video or capturing images using a mobile device and then upload the captured data into EdgeFirst Studio for annotation and then model training, validation, and deployment on various platforms. 
...
3. Upload Videos or Images
    ...
    First you will be importing the video recording from [step 1](#end-to-end-workflow).  Click on the dropdown that says "Select an Import Type" and then specify "Video" and then click "Done" as shown below. 
    ...
    Next, if you have captured images from [step 1](#end-to-end-workflow) you will import the captured images.  Navigate back to the "Import Dataset" page (refer to the top of step 3).
