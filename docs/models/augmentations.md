...
!!! note
    This augmentation is not exposed as an option in EdgeFirst Studio because its transformation has no other variations, but model training utilizes this augmentation as part of the random selection of augmentations.
