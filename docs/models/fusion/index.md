...
Fusion models can be trained now in {{ studio_link("EdgeFirst Studio") }} using a Graphical User Interface by following four simple steps:
...
{{ figure("../assets/cube.png", "Radar Data Cube", width="50%") }}
