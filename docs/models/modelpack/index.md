...
ModelPack (MPK) is an advanced computer vision solution developed by Au-Zone Technologies as part of our EdgeFirst AI middleware. It provides both object detection and instance segmentation capabilities, enabling high-performance, low-latency AI inference on embedded devices — particularly those leveraging NXP’s processors and hardware accelerators.
