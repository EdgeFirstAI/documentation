...
![Fields](../assets/adv_foxglove-fields.png){align=center}
...
<figure markdown="span">
![Top Level Fields](../assets/adv_foxglove-fusion_top_level_fields.png){align=center}
<figcaption>Top Level Fields</figcaption>
</figure>

The Fusion and Vision Class are produced by Fusion service on the Raivin.  They will report 0 for any cluster not identified as a person and 1 for any cluster as belonging to a human.  The Raivin WebUI can use [either class or both classes together](../../platforms/configuration/webui.md#draw-pcd) to determine if any radar target is a person or not.
...
1. From a panel in Foxglove, click the "More" kebab icon and change the panel to a "3D" panel.  
    ...
    <figcaption>Change to 3D</figcaption>
    </figure>

2. Click the "Settings" gear icon for the panel to open up the Settings Panel.  

    <figure markdown="span">
    ![Settings Panel](../assets/adv_foxglove-settings_panel.png){align=center}
...
4. In the "Topics" side-panel, click the "visibility" closed-eye icon on the "/fusion/targets" to view the topic.  
    ...
    <figure markdown="span">
    ![Visible Topic](../assets/adv_foxglove-visible.png){align=center}
    <figcaption>Visible Topic</figcaption>
    </figure>
...
5. Expand the "/fusion/topics" settings and configure the following settings:
    ...
    <figure markdown="span">
    ![Fusion Settings](../assets/adv_foxglove-fusion_class.png){align=center}
    <figcaption>Fusion Settings</figcaption>
    </figure>
...
<figure markdown="span">
![Finished](../assets/adv_foxglove-finished_fusion.png){align=center}
...
1. On the "More" kebab icon of the fusion class, split the panel (in this case, down)
    ...
    <figcaption>Split Down</figcaption>
    </figure>
...
<figure markdown="span">
![Both Classes](../assets/adv_foxglove-both_class.png){align=center}
<figcaption>Both Classes</figcaption>
</figure>
...
<figure markdown="span">
![User Scripts](../assets/adv_foxglove-user_scripts.png){align=center}
...
We then have the for loop that goes through each Fusion target and determines what the Fusion and Vision classes report.  We create a new reader at the starting offset of the target ``ii*p_step``, and read the values at offsets 28 and 32, respectively for `fusion_class` and `vision_class`.  If either value is 1, it will append the information to the output array.
...
<figure markdown="span">
![Final Script](../assets/adv_foxglove-data_source_info.png){align=center}
<figcaption>Final Script</figcaption>
</figure>
...
<figure markdown="span">
![Final Script](../assets/adv_foxglove-script_final.png){align=center}
<figcaption>Final Script</figcaption>
</figure>
