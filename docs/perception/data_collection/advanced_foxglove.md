...
{{ figure("../assets/adv_foxglove-fields.png", "Fields") }}
...
{{ figure("../assets/adv_foxglove-finished_fusion.png", "Finished") }}
...
{{ figure("../assets/adv_foxglove-both_class.png", "Both Classes") }}
...
{{ figure("../assets/adv_foxglove-user_scripts.png", "User Scripts") }}
...
{{ figure("../assets/adv_foxglove-scripts.png", "User Scripts") }}
...
{{ figure("../assets/adv_foxglove-data_source_info.png", "Final Script") }}
