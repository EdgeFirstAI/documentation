...
It is assumed you have read the [introduction to Foxglove Studio](foxglove.md), familiarized yourself with the application, and have [downloaded an MCAP](recording.md#record-mcap) that has recorded the [`/fusion/targets` topic](configuration/mcap_recording.md#fusion-recording-raivin-only).
