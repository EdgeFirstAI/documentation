...
```
To add topics to be recorded, simply add them in the quoted portion as space-seperated items.  For example, if we wanted to add the 4K tiles topics, we would just change the line to:
```
