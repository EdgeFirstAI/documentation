...
We have included a [custom Raivin Layout for Foxglove Studio](assets/Raivin_Foxglove_Layout.json).To install it, please download it and follow the instructions below.
