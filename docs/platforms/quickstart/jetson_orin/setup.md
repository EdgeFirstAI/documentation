...
Now that you have set up your Jetson Orin, you can begin training your Vision model for deployment on this platform. First, [copy one of our ready-to-use datasets](copy_dataset.md) to use for training.
