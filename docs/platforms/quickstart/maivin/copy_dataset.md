...
Once you have your own project created, you can finally copy a dataset inside your project. Here you can see the newly created project "Object Detection" next to "Sample Project".
