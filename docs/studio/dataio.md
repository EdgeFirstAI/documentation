...
```
https://stage.edgefirst.studio/samples/upload
```
...
Endpoint: https://stage.edgefirst.studio/samples/export
...
Endpoint: https://stage.edgefirst.studio/samples/list
...
- Endpoint: https://stage.edgefirst.studio/samples/get
