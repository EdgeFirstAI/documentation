...
![Starting Page](studio-from-scratch.jpg){ align=center }
<figcaption>Projects Splash Page</figcaption>
</figure>

The project page lists the projects in the organization with their information. Ypu can got to the project datasets or trainers by clicking on any project card. The project page already contains a sample project called "Sample Project" with pre-populated datasets.

To return to this projects page from any other page, you can:
...
<figure markdown="span">
![Project Attributes](project-attributes.jpg){ align=center }
...
{% include-markdown "./create_project.md" %}
