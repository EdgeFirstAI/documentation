...
A new account receives **\$50.00 USD in free credits** upon sign-up to experience the features in EdgeFirst Studio, plus **\$15.00 USD in free credits every month** thereafter. Note that for multi-user tiers, the credits in the organization will be shared amongst the members. You can find more information on the [billing details](billing.md).
